    ...
    const properties = [
      {
        ...
        mapUrl: "https://www.google.com/maps/search/?api=1&query=Parque+Esplanada+Valparaiso+de+Goias",
        areaM2: 118,
        bedrooms: 3,
        bathrooms: 2,
        parkingSpaces: 2,
      ...
      },
      {
        ...
        mapUrl: "https://www.google.com/maps/search/?api=1&query=Centro+Luziania+GO",
        areaM2: 72,
        bedrooms: 2,
        bathrooms: 1,
        parkingSpaces: 1,
      ...
      },
      {
        ...
        status: "DISPONIVEL" as const,
        price: 198000,
        commissionPrice: 7000,
        city: "CIDADE_OCIDENTAL" as const,
        neighborhood: "Recreio Mossoró",
        address: "Quadra 18, lote 08",
        mapUrl: "https://www.google.com/maps/search/?api=1&query=Recreio+Mossoro+Cidade+Ocidental+GO",
        areaM2: 55,
        bedrooms: 2,
        bathrooms: 1,
        parkingSpaces: 1,
        availableUnits: ["01", "02", "03", "101", "102", "103"],
        acceptsFinancing: true,
        featured: true,
        brokerId: brokers[0].id,
